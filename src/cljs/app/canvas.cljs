...
;; This is a copy of rm-hull/monet.canvas except that it doesn't start a draw
;; loop. After constructing the entities, call (canvas/draw-once monet-canvas)
;; to draw.
...
(defn draw-once [{:keys [canvas updating? ctx active entities last-frame-time] :as mc}]
