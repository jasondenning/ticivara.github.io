...
var val_inner_width = (function (){var G__18475 = cljs.core.cst$kw$width.cljs$core$IFn$_invoke$arity$1(sanghati);
return Number(G__18475);
})();
var val_inner_height = (function (){var G__18476 = cljs.core.cst$kw$height.cljs$core$IFn$_invoke$arity$1(sanghati);
...
var x__$1 = (x * sc);
var y__$1 = (y * sc);
app.canvas.font_style(ctx,"30px \"Fira Sans\"");
...
app.canvas.font_style(ctx,"24px \"Fira Sans\"");
...
;
var vec__18477 = app.helpers.init_canvas(cljs.core.cst$kw$_SHARP_sanghati_DASH_panels_DASH_1_DASH_2_DASH_3_DASH_canvas,"img/sanghati-panels-1-2-3.svg");
var canvas_panels_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18477,(0),null);
var img_1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18477,(1),null);
app.canvas.add_entity(canvas_panels_1,cljs.core.cst$kw$background,app.canvas.entity(null,null,((function (sanghati,title,pos_pattern_width,pos_pattern_height,pos_img_offset_x,pos_img_offset_y,pos_text_offset_x,pos_text_offset_y,pattern_scale,text,text_title,text_num,vec__18477,canvas_panels_1,img_1){
return (function (ctx,val){
return app.canvas.draw_image.cljs$core$IFn$_invoke$arity$3(ctx,img_1,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$x,(pos_img_offset_x * pattern_scale),cljs.core.cst$kw$y,(pos_img_offset_y * pattern_scale),cljs.core.cst$kw$w,(pos_pattern_width * pattern_scale),cljs.core.cst$kw$h,(pos_pattern_height * pattern_scale)], null));
});})(sanghati,title,pos_pattern_width,pos_pattern_height,pos_img_offset_x,pos_img_offset_y,pos_text_offset_x,pos_text_offset_y,pattern_scale,text,text_title,text_num,vec__18477,canvas_panels_1,img_1))
));
...
;
var vec__18480 = app.helpers.init_canvas(cljs.core.cst$kw$_SHARP_sanghati_DASH_panels_DASH_4_DASH_5_DASH_6_DASH_canvas,"img/sanghati-panels-4-5-6.svg");
var canvas_panels_4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18480,(0),null);
var img_4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18480,(1),null);
app.canvas.add_entity(canvas_panels_4,cljs.core.cst$kw$background,app.canvas.entity(null,null,((function (sanghati,title,pos_pattern_width,pos_pattern_height,pos_img_offset_x,pos_img_offset_y,pos_text_offset_x,pos_text_offset_y,pattern_scale,text,text_title,text_num,vec__18480,canvas_panels_4,img_4){
return (function (ctx,val){
return app.canvas.draw_image.cljs$core$IFn$_invoke$arity$3(ctx,img_4,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$x,(pos_img_offset_x * pattern_scale),cljs.core.cst$kw$y,(pos_img_offset_y * pattern_scale),cljs.core.cst$kw$w,(pos_pattern_width * pattern_scale),cljs.core.cst$kw$h,(pos_pattern_height * pattern_scale)], null));
});})(sanghati,title,pos_pattern_width,pos_pattern_height,pos_img_offset_x,pos_img_offset_y,pos_text_offset_x,pos_text_offset_y,pattern_scale,text,text_title,text_num,vec__18480,canvas_panels_4,img_4))
));
...
;
var vec__18483 = app.helpers.init_canvas(cljs.core.cst$kw$_SHARP_sanghati_DASH_panels_DASH_7_DASH_8_DASH_9_DASH_canvas,"img/sanghati-panels-7-8-9.svg");
var canvas_panels_7 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18483,(0),null);
var img_7 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18483,(1),null);
app.canvas.add_entity(canvas_panels_7,cljs.core.cst$kw$background,app.canvas.entity(null,null,((function (sanghati,title,pos_pattern_width,pos_pattern_height,pos_img_offset_x,pos_img_offset_y,pos_text_offset_x,pos_text_offset_y,pattern_scale,text,text_title,text_num,vec__18483,canvas_panels_7,img_7){
return (function (ctx,val){
return app.canvas.draw_image.cljs$core$IFn$_invoke$arity$3(ctx,img_7,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$x,(pos_img_offset_x * pattern_scale),cljs.core.cst$kw$y,(pos_img_offset_y * pattern_scale),cljs.core.cst$kw$w,(pos_pattern_width * pattern_scale),cljs.core.cst$kw$h,(pos_pattern_height * pattern_scale)], null));
});})(sanghati,title,pos_pattern_width,pos_pattern_height,pos_img_offset_x,pos_img_offset_y,pos_text_offset_x,pos_text_offset_y,pattern_scale,text,text_title,text_num,vec__18483,canvas_panels_7,img_7))
));
