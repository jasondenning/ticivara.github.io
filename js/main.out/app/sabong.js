...
var val_buffer_width = (function (){var G__16307 = cljs.core.cst$kw$buffer_DASH_width.cljs$core$IFn$_invoke$arity$1(sabong);
return Number(G__16307);
})();
var val_inner_width = (function (){var G__16308 = cljs.core.cst$kw$width.cljs$core$IFn$_invoke$arity$1(sabong);
return Number(G__16308);
})();
var val_inner_height = (function (){var G__16309 = cljs.core.cst$kw$height.cljs$core$IFn$_invoke$arity$1(sabong);
return Number(G__16309);
})();
var val_kusi_width = (function (){var G__16310 = cljs.core.cst$kw$kusi_DASH_width.cljs$core$IFn$_invoke$arity$1(sabong);
return Number(G__16310);
})();
var vec__16301 = app.helpers.calc_shrinking_lengths(cljs.core.cst$kw$sabong.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(data)));
var val_cut_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16301,(0),null);
var val_cut_height = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16301,(1),null);
var val_mandala_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16301,(2),null);
var val_mandala_height = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16301,(3),null);
var val_border_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16301,(4),null);
var val_border_height = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16301,(5),null);
var text = ((function (sabong,title,pos_pattern_width,pos_pattern_height,pos_img_offset_x,pos_img_offset_y,pos_text_offset_x,pos_text_offset_y,pos_buffer_width,pos_border_width,pos_kusi_width,pos_mandala_width,pos_mandala_height,pattern_scale,val_buffer_width,val_inner_width,val_inner_height,val_kusi_width,vec__16301,val_cut_width,val_cut_height,val_mandala_width,val_mandala_height,val_border_width,val_border_height){
...
var sabong = cljs.core.cst$kw$sabong.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(data));
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$container,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$id,"sabong"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h3$s_DASH_title,app.text.text(cljs.core.cst$kw$sabong)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$docs_DASH_note,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h5$s_DASH_title,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$id,"sabong-pattern"], null),app.text.text(cljs.core.cst$kw$pattern)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$columns,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$col_DASH_6,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$form,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$form_DASH_group,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$label$form_DASH_label,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$for,"pattern_title"], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(app.text.text(cljs.core.cst$kw$title)),":"].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$input$form_DASH_input,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$id,"pattern_title",cljs.core.cst$kw$type,"text",cljs.core.cst$kw$value,cljs.core.cst$kw$title.cljs$core$IFn$_invoke$arity$1(sabong),cljs.core.cst$kw$on_DASH_change,((function (sabong){
return (function (e){
