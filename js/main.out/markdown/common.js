...
var len__9122__auto___14116 = arguments.length;
var i__9123__auto___14117 = (0);
while(true){
if((i__9123__auto___14117 < len__9122__auto___14116)){
args__9129__auto__.push((arguments[i__9123__auto___14117]));

var G__14118 = (i__9123__auto___14117 + (1));
i__9123__auto___14117 = G__14118;
continue;
} else {
}
break;
...
markdown.common.freeze_string.cljs$lang$applyTo = (function (seq14115){
return markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14115));
});
...
var G__14121 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__4655__auto__){
return (function (s,r){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.cst$kw$frozen_DASH_strings.cljs$core$IFn$_invoke$arity$1(state),p1__14119_SHARP_,p1__14119_SHARP_);
});})(text,state,matches,temp__4655__auto__))
);
});})(text,state,matches,temp__4655__auto__))
,text,matches);
var G__14122 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,cljs.core.cst$kw$frozen_DASH_strings,((function (text,state,matches,temp__4655__auto__){
return (function (p1__14120_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__14120_SHARP_,matches);
});})(text,state,matches,temp__4655__auto__))
);
text = G__14121;
state = G__14122;
...
var vec__14125 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__14128 = (function (){var G__14131 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__14132 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__14131,G__14132) : transformer.call(null,G__14131,G__14132));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14128,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14128,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14125,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14125,(1),null);
var G__14134 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__14135 = cljs.core.PersistentVector.EMPTY;
var G__14136 = cljs.core.rest(tokens);
var G__14137 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,cljs.core.cst$kw$found_DASH_token,false);
out = G__14134;
buf = G__14135;
tokens = G__14136;
cur_state = G__14137;
...
var G__14138 = out;
var G__14139 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__14140 = cljs.core.rest(tokens);
var G__14141 = cur_state;
out = G__14138;
buf = G__14139;
tokens = G__14140;
cur_state = G__14141;
...
var G__14142 = out;
var G__14143 = buf;
var G__14144 = cljs.core.rest(tokens);
var G__14145 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,cljs.core.cst$kw$found_DASH_token,true);
out = G__14142;
buf = G__14143;
tokens = G__14144;
cur_state = G__14145;
...
var G__14146 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__14147 = buf;
var G__14148 = cljs.core.rest(tokens);
var G__14149 = cur_state;
out = G__14146;
buf = G__14147;
tokens = G__14148;
cur_state = G__14149;
...
var fexpr__14150 = markdown.common.make_separator.cljs$core$IFn$_invoke$arity$4(separator,open,close,(cljs.core.truth_(escape_QMARK_)?markdown.common.escape_code_transformer:cljs.core.identity));
return (fexpr__14150.cljs$core$IFn$_invoke$arity$2 ? fexpr__14150.cljs$core$IFn$_invoke$arity$2(text,state) : fexpr__14150.call(null,text,state));
});
...
var fexpr__14151 = markdown.common.make_separator.cljs$core$IFn$_invoke$arity$4(markdown.common._STAR_inhibit_separator_STAR_,"","",markdown.common.freeze_string);
return (fexpr__14151.cljs$core$IFn$_invoke$arity$2 ? fexpr__14151.cljs$core$IFn$_invoke$arity$2(text,state) : fexpr__14151.call(null,text,state));
} else {
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [text,state], null);
}
});
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__14152_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__14152_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__14153_SHARP_){
return (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__14153_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__14153_SHARP_));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
