...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__8761__auto__ = (function markdown$lists$close_lists_$_iter__14272(s__14273){
...
var c__8759__auto__ = cljs.core.chunk_first(s__14273__$2);
var size__8760__auto__ = cljs.core.count(c__8759__auto__);
var b__14275 = cljs.core.chunk_buffer(size__8760__auto__);
if((function (){var i__14274 = (0);
while(true){
if((i__14274 < size__8760__auto__)){
var vec__14276 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__8759__auto__,i__14274);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14276,(0),null);
cljs.core.chunk_append(b__14275,["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(list_type)),">"].join(''));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__14275),markdown$lists$close_lists_$_iter__14272(cljs.core.chunk_rest(s__14273__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__14275),null);
}
} else {
var vec__14279 = cljs.core.first(s__14273__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14279,(0),null);
return cljs.core.cons(["</li></",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name(list_type)),">"].join(''),markdown$lists$close_lists_$_iter__14272(cljs.core.rest(s__14273__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__14283_SHARP_){
return (cljs.core.second(p1__14283_SHARP_) > num_indents);
...
var vec__14284 = cljs.core.last(cljs.core.cst$kw$lists.cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14284,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14284,(1),null);
...
var content = clojure.string.trim((function (){var G__14287 = text;
var G__14288 = (num_indents + (1));
return (markdown.common._STAR_substring_STAR_.cljs$core$IFn$_invoke$arity$2 ? markdown.common._STAR_substring_STAR_.cljs$core$IFn$_invoke$arity$2(G__14287,G__14288) : markdown.common._STAR_substring_STAR_.call(null,G__14287,G__14288));
})());
...
var vec__14289 = cljs.core.last(cljs.core.cst$kw$lists.cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14289,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14289,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__14292){
...
var state = map__14293__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14293__$1,cljs.core.cst$kw$code);
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14293__$1,cljs.core.cst$kw$codeblock);
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14293__$1,cljs.core.cst$kw$last_DASH_line_DASH_empty_QMARK_);
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14293__$1,cljs.core.cst$kw$eof);
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14293__$1,cljs.core.cst$kw$lists);
