...
var G__13861 = o;
(G__13861[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13862__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__13862 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__13863__i = 0, G__13863__a = new Array(arguments.length -  0);
while (G__13863__i < G__13863__a.length) {G__13863__a[G__13863__i] = arguments[G__13863__i + 0]; ++G__13863__i;}
  args = new cljs.core.IndexedSeq(G__13863__a,0,null);
} 
...
var G__13867 = jsprops;
(G__13867["defaultValue"] = value);

(G__13867["onChange"] = ((function (G__13867,v,value,on_change){
return (function (p1__13866_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13866_SHARP_);
});})(G__13867,v,value,on_change))
);
...
var vec__13870 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13870,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13870,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13870,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13874 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13874 == null)){
} else {
var key_13875 = temp__4661__auto___13874;
(jsprops["key"] = key_13875);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13876 = reagent.impl.template.__GT_NativeWrapper();
(G__13876["name"] = c);
...
var G__13877 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13877) : reagent.impl.template.as_element.call(null,G__13877));
} else {
...
var len__9122__auto___13882 = arguments.length;
var i__9123__auto___13883 = (0);
while(true){
if((i__9123__auto___13883 < len__9122__auto___13882)){
args__9129__auto__.push((arguments[i__9123__auto___13883]));

var G__13884 = (i__9123__auto___13883 + (1));
i__9123__auto___13883 = G__13884;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13880){
var G__13881 = cljs.core.first(seq13880);
var seq13880__$1 = cljs.core.next(seq13880);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13881,seq13880__$1);
});
...
break;
default:
var G__13887 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13887;
continue;
...
var n__8898__auto___13889 = a.length;
var i_13890 = (0);
while(true){
if((i_13890 < n__8898__auto___13889)){
(a[i_13890] = reagent.impl.template.as_element((a[i_13890])));

var G__13891 = (i_13890 + (1));
i_13890 = G__13891;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8898__auto___13892 = a.length;
var i_13893 = (0);
while(true){
if((i_13893 < n__8898__auto___13892)){
var val_13894 = (a[i_13893]);
if((cljs.core.vector_QMARK_(val_13894)) && ((reagent.impl.template.key_from_vec(val_13894) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13893] = reagent.impl.template.as_element(val_13894));

var G__13895 = (i_13893 + (1));
i_13893 = G__13895;
continue;
} else {
}
...
var ctx = ({});
var vec__13896 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
...
var G__13899 = (cljs.core.count(argv) - first_child);
switch (G__13899) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13899){
