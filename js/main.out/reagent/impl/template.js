...
var G__13902 = o;
(G__13902[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13903__delegate = function (args){
...
while (G__13904__i < G__13904__a.length) {G__13904__a[G__13904__i] = arguments[G__13904__i + 0]; ++G__13904__i;}
  args = new cljs.core.IndexedSeq(G__13904__a,0,null);
} 
return G__13903__delegate.call(this,args);};
...
return G__13903__delegate(args);
});
...
var G__13908 = jsprops;
(G__13908["defaultValue"] = value);

(G__13908["onChange"] = ((function (G__13908,v,value,on_change){
return (function (p1__13907_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13907_SHARP_);
});})(G__13908,v,value,on_change))
);
...
var vec__13911 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13911,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13911,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13911,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13915 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13915 == null)){
} else {
var key_13916 = temp__4661__auto___13915;
(jsprops["key"] = key_13916);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13917 = reagent.impl.template.__GT_NativeWrapper();
(G__13917["name"] = c);
...
var G__13918 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13918) : reagent.impl.template.as_element.call(null,G__13918));
} else {
...
var len__9122__auto___13923 = arguments.length;
var i__9123__auto___13924 = (0);
while(true){
if((i__9123__auto___13924 < len__9122__auto___13923)){
args__9129__auto__.push((arguments[i__9123__auto___13924]));

var G__13925 = (i__9123__auto___13924 + (1));
i__9123__auto___13924 = G__13925;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13921){
var G__13922 = cljs.core.first(seq13921);
var seq13921__$1 = cljs.core.next(seq13921);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13922,seq13921__$1);
});
...
break;
default:
var G__13928 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13928;
continue;
...
var n__8898__auto___13930 = a.length;
var i_13931 = (0);
while(true){
if((i_13931 < n__8898__auto___13930)){
(a[i_13931] = reagent.impl.template.as_element((a[i_13931])));

var G__13932 = (i_13931 + (1));
i_13931 = G__13932;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8898__auto___13933 = a.length;
var i_13934 = (0);
while(true){
if((i_13934 < n__8898__auto___13933)){
var val_13935 = (a[i_13934]);
if((cljs.core.vector_QMARK_(val_13935)) && ((reagent.impl.template.key_from_vec(val_13935) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13934] = reagent.impl.template.as_element(val_13935));
...
var G__13940 = (cljs.core.count(argv) - first_child);
switch (G__13940) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13940){
